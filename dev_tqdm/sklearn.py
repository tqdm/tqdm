...
def sklearn(tclass, *targs, **tkwargs):
    ...
    def progress_cross_val(option, estimator, X, *args, cv=5, **kwargs):
        ...
        valid_options = ['predict', 'score', 'validate', 'learning_curve', 'permutation_test_score']
        ...
        elif isinstance(cv, collections.Iterable):
    ...
    aliases = cross_val_predict_alias + cross_val_score_alias + cross_validate_alias + learning_curve_alias + permutation_test_score_alias
    for name in aliases:
